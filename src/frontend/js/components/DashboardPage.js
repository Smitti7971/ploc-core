 ...
 * Ploc: Interface com Lógica de Login/Cadastro Interativa
 */
export const renderDashboard = () => {
    ...
    container.innerHTML = `
        ...
        <div id="bottom-panel" style="
            position: absolute; bottom: -800px; left: 0; width: 100%; background: rgba(255, 255, 255, 0.04);
    ...
    setTimeout(() => {
        ...
        const togglePanel = () => {
            ...
            bottomPanel.style.bottom = isPanelOpen ? '0' : '-800px';
        };
