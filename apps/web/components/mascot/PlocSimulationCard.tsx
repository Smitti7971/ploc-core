...
export function PlocSimulationCard({
  ...
  return (
    <motion.div
      ...
      className="absolute bottom-[125%] left-1/2 -translate-x-1/2 w-[260px] bg-slate-950/95 border border-sky-500/30 rounded-2xl p-4 z-[99999] backdrop-blur-md flex flex-col gap-3 [box-shadow:0_20px_40px_rgba(0,0,0,0.5),_inset_0_0_15px_rgba(56,189,248,0.1)]"
    >
      {/* Header */}
