...
import { Brain, Activity, Heart, Bird, Flag } from 'lucide-react';
...
export function AttributePillars({ attributes, lastChanges, activeTooltip, setActiveTooltip }: AttributePillarsProps) {
